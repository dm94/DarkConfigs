  ...
  >
    ...
    <ul>
      <li>
        ...
        <p>
          Purpose: These cookies help to analyse the use of the website in order
          to improve it.
        </p>

        <p>
          The following table describes each cookie set by gtag.js. To learn
          more about the data that Analytics collects, see Safeguarding your
          data.
        </p>
        <ul>
    ...
    <p>
      ...
      with any of the terms set forth herein, we kindly ask that you do not use
      this website.
    </p>
    <ol>
      <li>
        ...
        <ul>
          <li>
            The user is solely responsible for the files they upload to the Site
            and their content. The Site does not claim ownership over the
            uploaded files and assumes no responsibility for their content.
          </li>
        </ul>
      </li>
      <li>
        ...
        <ul>
          <li>
            The user agrees not to upload or share files that infringe on
            copyrights, are illegal, defamatory, obscene, or in any way harmful
            to third parties.
          </li>
        </ul>
      </li>
      <li>
        ...
        <ul>
          <li>
            The Site reserves the right to remove any file that, in its sole
            discretion, violates these Terms or is deemed inappropriate.
          </li>
        </ul>
      </li>
      <li>
        ...
        <ul>
          <li>
            The Site shall not be liable for any damages, direct or indirect,
            arising out of or in connection with the use of the file upload
            feature. This includes, but is not limited to, loss of data,
      ...
      <li>
        ...
        <ul>
          <li>
            The user agrees to indemnify and hold the Site harmless from any
            claims, damages, or liabilities arising from the user's uploaded
      ...
      <li>
        ...
        <ul>
          <li>
            The Site reserves the right to modify these Terms at any time. Any
    ...
    <p>
      ...
      these Terms, please refrain from using this website.
    </p>
  </div>
</template>
<style scoped>
