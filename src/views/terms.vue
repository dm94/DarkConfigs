...
<template>
  <div class="flex container mx-auto p-4 gap-4 flex-col" data-testid="home-page">
    ...
    <ul>
      ...
      <li>
        <p><strong>Website</strong> refers to Dark Configs, accessible from <a href="https://darkconfigs.vercel.app"
            rel="external nofollow noopener" target="_blank">https://darkconfigs.vercel.app</a></p>
      </li>
      <li>
    ...
    <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal
      ...
      browser. You can learn more about cookies on <a href="https://gdpr.eu/cookies/" rel="external nofollow noreferrer"
        target="_blank">GDPR</a> article.
    </p>
    <p>We use both Session and Persistent Cookies for the purposes set out below:</p>
    <ul>
      <li>
        <p><strong>Analysis Policy</strong></p>
        <p>Administered by: Google</p>
        <p>Purpose: These cookies help to analyse the use of the website in order to improve it.</p>

        <p>The following table describes each cookie set by gtag.js. To learn more about the data that Analytics collects,
          see Safeguarding your data.</p>
        <ul>
          <li>Cookie name : _ga</li>
          <li>Default expiration time: 2 years</li>
          <li>Description: Used to distinguish users.</li>
        </ul>
        <ul>
          <li>Cookie name : _ga_(container-id)</li>
          <li>Default expiration time: 2 years</li>
          <li>Description: Used to persist session state.</li>
        </ul>
      </li>
    </ul>
    ...
    <ul>
      <li>Discord: <a href="https://discord.gg/FcecRtZ" rel="external nofollow noopener"
          target="_blank">https://discord.gg/FcecRtZ</a></li>
    </ul>
    <h2 class="text-4xl font-bold mx-auto">Other - Terms and conditions</h2>
    <p>These terms and conditions ("Terms") govern the use of the website. By using this web, you agree to be bound by
      these Terms. If you do not agree with any of the terms set forth herein, we kindly ask that you do not use this
      website.</p>
    <ol>
      <li>
        <strong>Ownership of Content and User Responsibility:</strong>
        <ul>
          <li>The user is solely responsible for the files they upload to the Site and their content. The Site does not
            claim ownership over the uploaded files and assumes no responsibility for their content.</li>
        </ul>
      </li>
      <li>
        <strong>Prohibited Content:</strong>
        <ul>
          <li>The user agrees not to upload or share files that infringe on copyrights, are illegal, defamatory, obscene,
            or in any way harmful to third parties.</li>
        </ul>
      </li>
      <li>
        <strong>Content Removal:</strong>
        <ul>
          <li>The Site reserves the right to remove any file that, in its sole discretion, violates these Terms or is
      ...
      <li>
        ...
        <ul>
          <li>The Site shall not be liable for any damages, direct or indirect, arising out of or in connection with the
            use of the file upload feature. This includes, but is not limited to, loss of data, profits, or business
            interruption.</li>
        </ul>
      </li>
      <li>
        ...
        <ul>
          <li>The user agrees to indemnify and hold the Site harmless from any claims, damages, or liabilities arising
            from the user's uploaded content or violation of these Terms.</li>
        </ul>
      </li>
      <li>
        <strong>Modification of Terms:</strong>
        <ul>
          <li>The Site reserves the right to modify these Terms at any time. Any changes will be effective immediately
            upon posting on the Site.</li>
        </ul>
      </li>
      <li>
        <strong>Governing Law:</strong>
        <ul>
          <li>These Terms shall be governed by and construed in accordance with the laws of [Jurisdiction], without regard
            to its conflict of law principles.</li>
        </ul>
      </li>
    </ol>
    <p>By using the Site, you acknowledge that you have read, understood, and agree to abide by these Terms and
      Conditions. If you do not agree with these Terms, please refrain from using this website.</p>
  </div>
</template>
<style scoped>
h1 {
